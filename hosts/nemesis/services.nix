...
}:
{
  ...
  modules.services.syncthing.user-level = true;
  ...
  modules.services.syncthing.user = "face";
  ...
  # SSH Server
  ############################################
  modules.services.ssh-server.enable = true;
  modules.services.ssh-server.authorizedKeys = [
