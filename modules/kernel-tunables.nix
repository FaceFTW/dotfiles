...
in
{
  ...
  config = {
    # Generally good things for Kernel
    # Credits:
    # - https://github.com/RGBCube/ncc/blob/master/modules/linux/kernel.nix
    ...
    # WSL Kernel has an issue with this option
    boot.kernel.sysctl."net.core.bpf_jit_enable" = mkIf (!kernel.isWSL) 0;
    ...
    boot.blacklistedKernelModules = [
      ...
      # Disable Only FireWire to prevent DMA attacks. I use thunderbolt currently
      "firewire-core"
    ];
  };
}
